...
class DropDown_DealiasRegionBased(core.Component):
    '''
    Interface for executing :py:func:`pyart.correct.dealias_region_based`
    '''
...
#            [Not Implemented]
        ...
        super(DropDown_DealiasRegionBased, self).__init__(name=name, parent=parent)
        self.central_widget = QtGui.QWidget()
        self.setCentralWidget(self.central_widget)
        self.layout = QtGui.QGridLayout(self.central_widget)
...
#                                "Vgatefilter": None}
    ...
    def addGeneralOptions(self):
        '''Mount Options Layout.'''
        self.radarButton = core.VariableDropBox("Drop Radar \nVariable Here.")
        QtCore.QObject.connect(self.radarButton, QtCore.SIGNAL("Dropped"), self.chooseRadar)
        self.generalLayout.addWidget(QtGui.QLabel("Radar"), 0, 0)
        self.generalLayout.addWidget(self.radarButton, 0, 1)
...
#        self.generalLayout.addWidget(QtGui.QLabel("NotImplemented"), 8, 1)
    ...
    def chooseRadar(self, var):
        ...
        common.ShowWarning("DEBUG INFORMATION\n"+
                           "Just dropped variable: '%s'\n" % var.value.__str__()+
                           "this is now linked in the Vradar slot")
...
_plugins = [DealiasRegionBased, DropDown_DealiasRegionBased]

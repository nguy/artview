...
class DealiasRegionBased_old(Component):
    '''
    Interface for executing :py:func:`pyart.correct.dealias_region_based`
    '''
...
#            [Not Implemented]
        ...
        super(DealiasRegionBased_old, self).__init__(name=name, parent=parent)
        self.central_widget = QtGui.QWidget()
        self.setCentralWidget(self.central_widget)
        self.layout = QtGui.QGridLayout(self.central_widget)
...
_plugins = [DealiasRegionBased, DealiasRegionBased_old]

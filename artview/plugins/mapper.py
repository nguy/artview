...
class Mapper(Component):
    ...
    def mountUI(self):
        ...
        self.configMenu.addAction(QtGui.QAction("Set General Parameters", self,
                                                triggered=self.setParameters))
        self.configMenu.addAction(QtGui.QAction("Set Radius of Influence Parameters", self,
                                                triggered=self.setRoiParameters))
        self.configMenu.addAction(QtGui.QAction("Set map_to_grid Parameters", self,
    ...
    def NewRadar(self, variable, strong):
        ...
        self.field_radio_group = QtGui.QActionGroup(self, exclusive=False)
        self.field_actions = {}
...
class Mapper_old(Component):
    ...
    def __init__(self, Vradar=None, Vgrid=None, name="Mapper", parent=None):
        ...
        parent : PyQt instance
            ...
            If None, then Qt owns, otherwise associated w/ parent PyQt instance
        '''
        super(Mapper_old, self).__init__(name=name, parent=parent)
        self.central_widget = QtGui.QWidget()
        self.setCentralWidget(self.central_widget)

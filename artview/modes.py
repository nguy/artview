...
modes = {
         ...
         'select_region': {'label': 'Query a selectable region of interest ',
                           'action': select_region_mode},
         'extract_points': {'label': 'Extract a selected region of points',
                            'action': extract_points_mode},
         'manual_unfold': {'label': 'Manually unfold velocity',

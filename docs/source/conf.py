...
version = re.sub(r'^(\d+\.\d+)\.\d+(.*)', r'\1\2', artview.__version__)
if 'dev' in version:
...
intersphinx_mapping = {
    'pyart': ('https://arm-doe.github.io/pyart/dev/', None),
...
for name in ['sphinx.ext.linkcode', 'linkcode', 'numpydoc.linkcode']:
    ...
    print("NOTE: linkcode extension not found -- "
          "no links to source generated")
